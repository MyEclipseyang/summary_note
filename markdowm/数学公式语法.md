...
> 本文为 MathJax 在 [Cmd Markdown](https://www.zybuluo.com/mdeditor?url=https://www.zybuluo.com/static/editor/md-help.markdown) 环境下的常用语法指引。Cmd Markdown 编辑阅读器支持 $\LaTeX$ 编辑显示支持，例如：
> $$
> \sum_{i=1}^n a_i=0
> $$
...
> \large\rm{Detexify}
> $$
> [来画出想要的符号](http://detexify.kirelabs.org/classify.html)
